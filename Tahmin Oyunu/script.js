...
const oncekiTahmin = document.querySelector('.onceki-tahminler')
...
function karsilastir(){
    ...
    if(isNaN(tahminNum)){
        ...
        document.body.innerHTML = '<p class="text-center fs-1 fw-bold text-danger">Rakam yazsaydın oynardın</p>'
        ...
        if(tahminNum < random){
            ...
            yaziHandle('Tebrikler KAZANDIN!',['text-danger','text-warning','text-primary'],'text-success')
        ...
        if(hak == 0 && random != tahminNum){
            yaziHandle('Kaybettin!',['text-warning','text-danger'],'text-secondary')
